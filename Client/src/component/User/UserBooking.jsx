                  ...
                  <div title={isCancelled ? 'This Booking is Cancelled' : ''}>
                    <Card className={`shadow-sm ${isCancelled ? 'cancelled-card' : ''}`}>
                      <div className="d-flex flex-column flex-md-row">
                        {/* Image Section */}
                        <div className="w-100 w-md-25" style={{ maxWidth: 250, flexShrink: 0 }}>
                          {booking.package?.poster? (
                            <Image
                              src={`${API_BASE_URL}/uploads/${booking.package.poster}`}
                              alt={booking.package.package_name}
                              style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: 6, minHeight: 180 }}
                              onError={(e) => {
                        ...
                        <Card.Body className="d-flex flex-column w-100">
                          <div className="d-flex flex-column h-100">
                            ...
                            <div className="mt-auto pt-2 border-top">
                              ...
                              {booking.status === 'Confirm' && booking.paymentStatus === 'Pending' && (
                                <Button
                                  variant="success"
                                  size="sm"
                              ...
                              {booking.status === 'Cancelled' && (
                                <p className="text-danger mt-2 small">This Booking is Cancelled By You.</p>
                              )}
                              {booking.status === 'Admin Cancelled' && (
                                <p className="text-danger mt-2 small">This Booking is Cancelled By Admin. <br />Contact Admin For More Details.</p>
                              )}
                            </div>
                          </div>
                        </Card.Body>
